...
class TestableData {
    ...
    static func clearData(context: NSManagedObjectContext) throws {
        try clearSpots(context: context)
        try clearFavorites(context: context)
    }
    
    private static func clearSpots(context: NSManagedObjectContext) throws {
    ...
    private static func clearFavorites(context: NSManagedObjectContext) throws {
